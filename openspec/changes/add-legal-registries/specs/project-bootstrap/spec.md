...
Интерфейс SHALL принимать три зацепки и MAY показать таблицу собранных полей со ссылкой или «не найдено», включая юрполя. Система MUST NOT строить индекс привлекательности и MUST NOT выдавать вывод модели как инвестиционный совет.
